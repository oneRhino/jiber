    ...
    public function entries()
    {
        return $this->hasMany('App\TogglTimeEntry', 'report_id')
            ->select(array(
                ...
                'toggl_time_entries.description',
                'toggl_time_entries.date',
                'toggl_time_entries.duration',
                'toggl_time_entries.jira',
                'toggl_time_entries.redmine',
                'toggl_time_entries.time',
