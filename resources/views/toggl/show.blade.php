...
@section('content')
  <div class="container">
    <div class="col-sm-offset-2 col-sm-8">
      @if (count($entries) > 0)
        <h2>Toggl Time Entries Comparison</h2>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form action="{{ action('TogglController@send') }}" method="post">
                                ...
                                <div class="panel-group">
                                    <div class="panel panel-default">
                                        @foreach ($_all_entries as $_redmine_task_id => $_entries)
                                            ...
                                            <div class="panel-heading">
                                                <h4 class="panel-title"><a data-toggle="collapse" href="#collapse-{{ date('mdy', strtotime($_date)) }}-{{ $_redmine_task_id }}">#{{ $_redmine_task_id }} <span class="fa fa-angle-down"></span></a></h4>
